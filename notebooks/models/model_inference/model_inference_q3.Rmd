...
data_for_models_scaled <-
    ...
    mutate(across(c("init_height", "amax", "gs", "wue", "d13c", "pnue",
                    "Narea_g_m2"), scale))
...
```{r}
min(data_for_models_scaled$amax)
max(data_for_models_scaled$amax)
plot_model(lme_rgr_3way,
            type = "pred",
            terms = c("amax[-1.13,2.80]", "treatment", "nfixer"))
```
