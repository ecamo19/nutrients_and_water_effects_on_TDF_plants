...
data_for_models_scaled <-
    ...
    mutate(across(c("init_height", "gs", "wue", "pnue", "Narea_g_m2",
                    "rgr", "root_shoot_ratio", "total_biomass"),
                scale))
...
```{r}
min(data_for_models_scaled$wue)
max(data_for_models_scaled$wue)
plot_model(lme_root_shoot_ratio_3way,
            type = "pred",
            terms = c("wue[-1.2, 5.2]", "nfixer", "treatment"))
```
