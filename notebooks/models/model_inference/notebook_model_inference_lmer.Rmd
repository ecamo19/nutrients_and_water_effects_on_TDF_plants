...
bootstrap_model_df <- function(model, iter = 100, type = c("norm","basic","perc")){
    ...
    lmeresampler::bootstrap_lmer <- 
        confint(bootstrap(models_q3_nlme$`abovebiomass~amax`,
                          .f = fixef, type = "parametric", B = 9999),
                method = "all", level= 0.95) %>%  
...
lmeresampler::bootstrap(models_q3_nlme$`abovebiomass~amax`, 
                        .f = fixef, type = "parametric", B = 1000)


resampler::bootstrap_lmer <- 
        confint(bootstrap(models_q3_nlme$`abovebiomass~amax`,
                          .f = fixef, type = "parametric", B = 9999),
                method = "all", level= 0.95)
...
```{r}
confint(bootMer(models_q3_nlme$`abovebiomass~amax`, fixef, nsim = 100)) 
confint(models_q3_nlme$`abovebiomass~amax`, oldNames = FALSE)
confint(bootMer(models_q3$`abovebiomass~amax`, fixef, nsim = 100))
```
