...
```{r fig_traits_q2_boxplot_interaction, fig.height = 6, fig.width = 7, fig.align = 'center'}
vars_q2 %>%
...
```{r fig_traits_q2_boxplot_treatments, fig.height = 6, fig.width = 7, fig.align = 'center'}
vars_q2_treat %>%

        filter(V1 %in% c('pred_gs', 'pred_nitrogen', 'pred_pnue')) %>%
