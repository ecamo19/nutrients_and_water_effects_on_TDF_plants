...
```{r}
car::Anova(model_nodule_count, type = "III")
```
...
```{r}
eff_size(emmeans(model_nodule_count, ~treatment|spcode),
         sigma = sigma(model_nodule_count),
         edf = df.residual(model_nodule_count))
```
