...
## AGR
```{r}
if (file.exists("./processed_data/bootstrap_ci_agr.RData")) {

    print("The bootstrap exists")

    bootstrap_ci_agr <- readRDS("./processed_data/bootstrap_ci_agr.RData")
    ...
    bootstrap_ci_agr <-
        bootstrap_model_ci_df(model = models_3way_q3$lme_agr_3way,
                              category = "all",

                                iter = 9999)
    saveRDS(bootstrap_ci_agr,
            file = "./processed_data/bootstrap_ci_agr.RData")
}
```
