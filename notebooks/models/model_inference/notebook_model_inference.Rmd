...
# Plot
(belowground_plot <- cleveland_plot(x = treat_trait, y = estimate,
                                   color = col_1,
                                   ci_lower = lower, ci_upper = upper,
...
# Plot
rgr_plot <- 
    cleveland_plot(x = treat_trait, y = estimate, shape = col_2,
                           color = col_1,
                           ci_lower = lower, ci_upper = upper,
                             data = data_rgr_plot) +
    facet_grid(.~col_2)
...
##
```{r figure_3_three_way_q3_2, fig.width = 40, fig.height = 20, fig.align = 'center'}
